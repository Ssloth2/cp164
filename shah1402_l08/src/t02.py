...
print(
    f"Is the Code for A equal to the Code for B? {'Yes' if code_a == code_b else 'No'}")
print(
    f"Does the Code for A come before the Code for B? {'Yes' if code_a < code_b else 'No'}")
print(
    f"Is the Code for A less than or equal to the Code for C? {'Yes' if code_a <= code_c else 'No'}")
