...
class Sorted_Set:
    ...
    def find(self, key):
        ...
        """
        index = self._binary_search(key)
        return deepcopy(self._values[index]) if index != -1 else None
    ...
    def __eq__(self, target):
        ...
        -------------------------------------------------------
        """
        equals = len(self._values) == len(
            target._values) and self._values == target._values
        return equals
    ...
    def issubset(self, target):
        ...
        """
        subset = len(
            [value for value in self._values if value not in target._values]) == 0
        return subset
