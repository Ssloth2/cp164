...
class Sorted_List:
    ...
    def insert(self, value):
        ...
        if self._front is None:
            ...
            node = _SL_Node(deepcopy(value), self._front)
            self._front = node
            ...
            node = _SL_Node(deepcopy(value), current)
            previous._next = node
    ...
    def __eq__(self, target):
        ...
        s_node = self._front
        while s_node is not None and equals:
